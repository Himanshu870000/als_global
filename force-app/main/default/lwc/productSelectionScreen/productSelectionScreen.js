...
import getPBERecords from "@salesforce/apex/QuoteScreenController.getPBERecords";
import getOppName from "@salesforce/apex/QuoteScreenController.getOppName";
const columns = [
...
connectedCallback() {
    ...
    @wire(getPBERecords,{priceName : "$isProductPricebook",QuoteId : "$recordId"})
    wiredData({error, data}){
        if(data){
            ...
            Method:data[i].Product1Id__r.Method__c,
            SalesPrice : data[i].List_Price__c,
